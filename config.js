var fs = require('fs'),
    ...
    configData = {
        ...
        fcm_key: 'AIzaSyBwdywTxMBWq2ZeOk_jaJLGKTMjOBsdfTo',
        email_header: `
        <!DOCTYPE html>
        <html>
        <head>
...
VAPID: {
      ...
      "privateKey": "dZEmtoW92ASkYil89jnvLbMUn5gan3Ebr5XlGxD4yyo"
        ...
        profile_path: 'http://10.10.10.86:7000/uploads/profile_images/',

        //team_profile_path: 'http://newagesme.com:7007/uploads/bid/',
        team_profile_path: 'http://10.10.10.86:7000/uploads/team_images/',
